...
public:
    ...
    void Log_Write_Camera_Vision1(const AP_AHRS::AHRS_Summary &ahrs_summary, const uint64_t &feedback_time, const uint16_t &image_index);
    void Log_Write_Camera_Vision2(const AP_AHRS::AHRS_Summary &ahrs_summary, const uint64_t &feedback_time, const uint16_t &image_index);
